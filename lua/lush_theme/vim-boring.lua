...
local theme = lush(function(injected_functions)
  ...
  --            1               2               3               4               5               6               7               8
  local alum = {hsl("#2e3436"), hsl("#555753"), hsl("#888a85"), hsl("#babdb6"), hsl("#d3d7cf"), hsl("#ecf0eb"), hsl("#f7f8f5"), hsl("#f7f8f5").lighten(50)};
  local yell = {hsl("#291e00"), hsl("#725000"), hsl("#c4a000"), hsl("#edd400"), hsl("#fce94f"), hsl("#fffc9c"), hsl("#feffd0"), hsl("#feffd0").lighten(50)};
  local oran = {hsl("#301700"), hsl("#8c3700"), hsl("#ce5c00"), hsl("#f57900"), hsl("#fcaf3e"), hsl("#ffd797"), hsl("#fff0d7"), hsl("#fff0d7").lighten(50)};
  local choc = {hsl("#271700"), hsl("#503000"), hsl("#8f5902"), hsl("#c17d11"), hsl("#e9b96e"), hsl("#efd0a7"), hsl("#faf0d7"), hsl("#faf0d7").lighten(50)};
  local cham = {hsl("#173000"), hsl("#2a5703"), hsl("#4e9a06"), hsl("#73d216"), hsl("#8ae234"), hsl("#b7f774"), hsl("#e4ffc7"), hsl("#e4ffc7").lighten(50)};
  local blue = {hsl("#00202a"), hsl("#0a3050"), hsl("#204a87"), hsl("#3465a4"), hsl("#729fcf"), hsl("#97c4f0"), hsl("#daeeff"), hsl("#daeeff").lighten(50)};
  local plum = {hsl("#170720"), hsl("#371740"), hsl("#5c3566"), hsl("#75507b"), hsl("#ad7fa8"), hsl("#e0c0e4"), hsl("#fce0ff"), hsl("#fce0ff").lighten(50)};
  local red =  {hsl("#270000"), hsl("#600000"), hsl("#a40000"), hsl("#cc0000"), hsl("#ef2929"), hsl("#f78787"), hsl("#ffcccc"), hsl("#ffcccc").lighten(50)};

  local dull = alum[4];  -- ~ white.darken(40);
  local deep = alum[1];  -- ~ white.darken(70);
  local todo = oran[5];
  local dullred = red[1];
  local darkred = red[2];
  local darkyellow = choc[2];
  local darkblue = blue[2];
  local darkgreen = cham[2];
  local darkviol = plum[3];
  local viol = plum[4];
  local lightviol = plum[6];
  local lightred = red[8];
  local lightyellow = choc[8];
  local lightgreen = cham[8];
  ...
  return {
    ...
    ColorColumn       { bg=deep }, -- Columns set with 'colorcolumn'
    -- Conceal        { }, -- Placeholder characters substituted for concealed text (see 'conceallevel')
    -- Cursor         { }, -- Character under the cursor
    CurSearch         { fg=white, bg=viol }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
    ...
    IncSearch         { bg=viol, fg=white }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
